...
housing = strat_train_set.drop("median_house_value", axis=1)  # type: ignore # drop labels for training set
...
feature_importances = grid_search.best_estimator_.feature_importances_  # type: ignore
