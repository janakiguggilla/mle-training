...
with mlflow.start_run(
    ...
    flag_var, rmse, mae, r2 = score.eval_metrics(
        data_path=os.path.join("housing_price/datasets", "housing"),
    ...
    with mlflow.start_run(
        ...
        flag_var = ingest_data.prepare_train(os.path.join("housing_price/datasets", "housing"))
    ...
    with mlflow.start_run(
        ...
        flag_var = train.training_data(
            os.path.join("housing_price/datasets", "housing"),
